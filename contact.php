...
Teen Connection: Afghanistan</span></h1>
  ...
  <div class="content">
    <div class="content_resize"><!-- InstanceBeginEditable name="mainbar" -->
    	<div class="mainbar">
        	<div class="textbox">
			<p style="font-size: 34px; color: rgb(64, 64, 64); font-weight: bold; line-height: 40px;">Contact Us:</p>
			<div class="clr"></div>
			<p>Thank you for your interest in Teen Connection:  Afghanistan.  Please send all inquiries to the address below.  A member of the TCA team will be in touch with you soon.</p>
			<div class="clr"></div>
			<p><a href="mailto:info@teenconnectionafghanistan.org">info@teenconnectionafghanistan.org</a></p>
			<div class="clr"></div>
    	</div>
    <!-- InstanceEndEditable -->

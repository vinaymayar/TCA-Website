  ...
  <div class="header">
    <div class="header_resize">
      <div class="searchform">
          <form style="margin: 12px 20px 8px 0px" name="login" method="post" action="login.php">
...
<p style="margin-bottom:0"><a href="members.html">Create an Account</a></p>
      ...
      <div class="logo">
        <h1><a href="./">Teen Connection: Afghanistan <small>We need a slogan</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="fbg_resize">
      ...
      <div class="col c3">
        ...
        <p class="contact_info"> <!--<span>Address:</span> 1458 TemplateAccess, USA<br />
          ...
          <span>E-mail:</span> --><a href="activistny@aol.com">Click Here to Email Us</a> </p>
      </div>
      <div class="clr"></div>
    </div>
  </div>
